...
<body>
   ...
   <?php require 'message.php'; ?>
        <div class="row mb-5">
            <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-center">When In Need Blood Bank</div>
                <div class="card-body text-center">
                    <p>We are here to help you when you are in need. </p>
                    <b>Contact:</b><br>
                    <i class="fa fa-envelope"> </i> <a > help@winbloodbank.com</a><br>
                    <i class="fa fa-mobile"> </i> <a > +91 739589866X</a><br>
                    <dt>
                </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    <div class="card-header text-center">Type A+</div>
                    <div class="card-body">
						<ul>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    <div class="card-header text-center">Type B+</div>
                    <div class="card-body">
						<ul>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    <div class="card-header text-center">Type AB+</div>
                    <div class="card-body">
					<ul>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    <div class="card-header text-center">Type O+</div>
                    <div class="card-body">
					<ul>
